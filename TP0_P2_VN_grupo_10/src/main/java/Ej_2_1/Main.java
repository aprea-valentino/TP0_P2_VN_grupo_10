...
public class Main {
    public static void main(String[] args) {
        ...
        IQueveOfStacks queveOfStacks2 = genQOS(n);
        System.out.println("           +");
        printQOS(queveOfStacks2);
        queveOfStacks = sumaMatricial(queveOfStacks, queveOfStacks2);
        System.out.println("La suma matricial es:");
        printQOS(queveOfStacks);
    }
